...
- **В РАБОТЕ (по фидбеку):** B — курирование в UI (галочки: какие клипы оставить) +
  выбор количества рилсов (max_clips уже в config; нужен UI-контрол + чекбоксы + скачивание выбранных).
