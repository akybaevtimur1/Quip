...
- **В РАБОТЕ (по фидбеку):** C — clean-start (кривой старт «Антимошенника» — первое слово
  клипа бессмысленно вне контекста); B — курирование в UI (галочки: какие клипы оставить) +
  выбор количества рилсов. reframe-статик заменён динамикой (см. выше).
